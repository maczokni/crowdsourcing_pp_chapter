...
There are many more things one can do with these data. For example, we could look at the descriptive statistics of the proportion of 'safer' votes in each area: 
