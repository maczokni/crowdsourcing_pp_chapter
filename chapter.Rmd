...
Although crowdsourced data about public perceptions of space and safety have some key strengths over data recorded from traditional survey methods (e.g., precise spatial data, information about immediate environmental variables, reduced cost), their unique mode of production is also associated with certain limitations or weaknesses that, if uncontrolled, may affect the validity of such measures and the reliability of final results [@builgil2020; @elliott2017]. Amongst those limitations identified by researchers using crowdsourced data to study emotions about crime, the ones that are most commonly mentioned are related to the participation inequality arising from participants' self-selection, difficulty to interpret results, and under-representation of certain areas and times [@solymosi2020]. Others also identify that the number of participants in crowdsourcing projects tends to decrease over time (i.e., participation decrease), and some platforms have difficulties to engage participant and can only record small samples [e.g., @blom2010]. We will briefly review some of these strengths and weaknesses of crowdsourced data and illustrate some of them with crowdsourced data about perceptions of safety in Atlanta.

@solymosi2020 conducted a systematic review of 27 studies published between 2010 and 2018 utilizing or discussing the use of crowdsourcing to study perceptions and emotions about crime. The most frequent strength of crowdsourcing and app-based methods identified by researchers was that these techniques allow capturing the spatial-temporal specific nature of emotions about crime, which was identified by 23 out of 27 papers. It is well known today that 'mental events' of fear of crime are qualitatively and quantitatively different from 'mental states' of worry or anxiety: whereas emotional reactions of fear take place under the presence of situational and context-specific elements that make the person feel threatened [@castrotoledo2017], concerns and worries about crime refer to more general concerns about both immediate and future risks [@builgil2019; @hough2004]. Thus, crowdsourcing techniques powered by digital technologies enable recording emotions of fear of crime in their precise space and time, which allows ultimately to "un-erroneously associate them [experiences of fear] with elements of the environmental backcloth such as incivilities, crime, and disorder” [@solymosi2015, p. 198]. This is related to another important strength of crowdsourcing: these techniques also allow recording data about the architechtural features and environmental characteristics of spaces where mental events of fear are more common [@chataway2017; @traunmueller2015].

Another obvious advantage of crowdsourcing is its reduced cost of data collections. Large volumes of data can be recorded at a very low cost. As an example, @dubey2016 analyzed more than 350,000 votes of perceived safety recorded from the Place Pulse platform, and @solymosi2017 analyzed more than 275,000 reports of disorder in London. These large sample sizes are very costly to record by using traditional sample surveys. In this chapter we will illustrate how to download data about more than 1.5 million votes registered from the Place Pulse platform. and we will analyze more than 35,000 votes online perceived safety in Atlanta.

Crowdsorucing offer advantages over other methods to record data about perceptions of space and crime, but its unique mode of production also create certain challenges that may affect the validity and precision of recorded data. Perhaps the main weakness of data recorded from crowdsourcing is related to the participants' self-selection. While probability surveys are carefully designed to select participants randomly, and thus all units in the population have equal probability of being chosen, crowdsourcing projects harness data from non-probability samples who decide when and where to share their perceptions and emotions, or whether they want to participate at all [@elliott2017]. The mode of production of crowdsourced data increases the risk of self-selection bias, and as a consequence males and youngs citizens tend to be overrepresented in crowdsourced data [@chataway2017] and citizens from deprived areas are generally less represented than persons from wealthy areas [@solymosi2018]. For example, @salesses2015 observed that 78.3% of those participants who informed about their gender when using the Place Pulse platform were males, and @solymosi2017 highlight that only 26.0% of those who informed about their gender when reporting instances of disorder via FixMyStreet were females.

Those crowdsourcing platforms that allow participants to vote multiple times may also suffer from participation inequality (or unequal participation). In order words, "it is often observed that few users are responsible for most crowdsourced information, while the majority participate only a few times" [@builgil2020, p. 6]. To illustrate this, @dubey2016 shows that 6,118 of the 81,730 persons who used the Place Pulse platform participated only once, while 30 users participated more than 1,000 times and the most prolific user voted 7,168 times. @solymosi2017 also shows that one fourth of all FixMyStreet reports are produced by one percent of participants, and 73% of persons contribute only once.

The fact that participants of crowdsourcing projects can decide where and when to participate also explains why certain areas and times are under-represented. For instance, it is likely that app-based platforms fail to capture data from high-crime-density areas, since participants may avoid those areas where they feel exposed to crime [@innes2015]. The routine activity of participants is also reflected on an under-representation of votes at night [@blom2010].

Finally, there are also ethical considerations that may arise from the use of crowdsourcing, which are related to the user's privacy (e.g., risk of participants identification) but also concerns that these techniques may sensitize participant and increase their fear of crime by asking them to constantly think about crime-related risks [@jackson2015; @solymosi2020].


ADD REFS: @innes2015 @jackson2015
...
# download json file from WorldMap of Harvard University
