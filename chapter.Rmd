...
We have saved all Place Pulse data (more than 1.5 million votes) in a data repository on [FigShare: figshare.com/articles/Place_Pulse/11859993](https://figshare.com/articles/Place_Pulse/11859993). You can download this directly into `R` by using the `read.csv()` function. It is a large file so it may take some minutes to read in.
